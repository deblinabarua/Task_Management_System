...
class Employee(Base):
    ...
    access: Mapped[str] = mapped_column(Enum('Admin', 'Manager', 'Employee', name = 'access_enum'), nullable = False)
...
class Tasks(Base):
    ...
    projectid: Mapped[int] = mapped_column(ForeignKey("projects.projectid"), nullable = False)
...
class ProjectAssignment(Base):
    ...
    psno: Mapped[int] = mapped_column(primary_key = True, autoincrement = True)
    projectid: Mapped[int] = mapped_column(ForeignKey("projects.projectid"), nullable = False)
    empid: Mapped[int] = mapped_column(ForeignKey("employee.empid"))
    role: Mapped[str] = mapped_column(Enum("Owner", "Member", "Viewer", name = "project_role"))

class TaskAssignment(Base):
    __tablename__ = "task_assignment"
    tsno: Mapped[int] = mapped_column(primary_key = True, autoincrement = True)
